...
void report2Master(){
  ...
  message[9] = END_CHAR;
  */
  String message  = ((char)(START_CHAR)) + String("V0") + String( energyGenerated , 2 ) + ((char)(END_CHAR)) + 
                    ((char)(START_CHAR)) + String("V1") + String(        tempLM35 , 2 ) + ((char)(END_CHAR));

  char charMSG[60];
  message.toCharArray( charMSG, 60 );
  ...
  message         = ((char)(START_CHAR)) + String("V2") + String(             lux , 2 ) + ((char)(END_CHAR)) + 
  ...
  message         = ((char)(START_CHAR)) + String("V4") + String(     loadvoltage , 2 ) + ((char)(END_CHAR)) + 

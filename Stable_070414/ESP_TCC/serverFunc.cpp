...
String var07_HTML = "Unknown"; //Solar Tracker Unit - (Energy Generated Today)
...
//Control Unit Data
String var19_HTML = "Unknown"; //Control Unit - (Energy Generated Today)
    ...
    if( buffer_read.indexOf( START_CHAR ) == 0 ){
      ...
      while( ( buffer_read.indexOf( END_CHAR ) >= 4 ) and (iterationCounter < 10) ) {
        ...
        if( buffer_read.indexOf( 'V' ) == 1 ){
          ...
          else if( buffer_read.substring( 2,4 ) == "17" ){ var17_HTML = buffer_read.substring( 4, buffer_read.indexOf( END_CHAR ) ) + " [º]";  }
          else if( buffer_read.substring( 2,4 ) == "18" ){ var18_HTML = buffer_read.substring( 4, buffer_read.indexOf( END_CHAR ) ) + " [º}";  }
          ...
          else if( buffer_read.substring( 2,4 ) == "23" ){ var23_HTML = buffer_read.substring( 4, buffer_read.indexOf( END_CHAR ) ) + " [ºC]"; }
          ...
          else if( buffer_read.substring( 2,4 ) == "29" ){ var29_HTML = buffer_read.substring( 4, buffer_read.indexOf( END_CHAR ) ) + " [º]";  }
          else if( buffer_read.substring( 2,4 ) == "30" ){ var30_HTML = buffer_read.substring( 4, buffer_read.indexOf( END_CHAR ) ) + " [º}";  }
        ...
        //REPORT ALERT
          ...
          if(      buffer_read.substring(4,5) == "0" ){
            String MailContent = "<html>\n<body>\n<b>Intrude Alert Detected</b> at <i>" + var03_HTML + " of " + var04_HTML + "</i>\n</body>\n</html>";
...
void handleXML(){
  ...
  XML+="  <rvar30>" + var31_HTML + "</rvar30>\n";
  XML+="  <rvar30>" + var32_HTML + "</rvar30>\n";
  XML+="</response>\n";
...
void buildWebsite(){
  ...
  websiteHTML += "<tr><td align=left width='220px'></td>\n";
  websiteHTML +=     "<td align=center width=190px> Solar Tracker </td>\n";
  websiteHTML +=     "<td align=center width=190px> Control </A> </td></tr>\n";
  websiteHTML += "<tr><td align=left width='220px'> Energy Generated</td>\n";
  websiteHTML +=     "<td align=center> <A id='var07'></A> </td>\n";
  websiteHTML +=     "<td align=center> <A id='var19'></A> </td></tr>\n";
  websiteHTML += "<tr><td align=left width='220px'> milliampere Hour</td>\n";
